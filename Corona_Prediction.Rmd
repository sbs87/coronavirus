...
Corona_Cases.US_state.tmp<-merge(Corona_Cases.US_state,rename(mobility,c("State"="Province.State","County"="City")))
...
ddply(plot_data,c("Province.State"),summarise,cor=cor(y =Total_confirmed_cases.perperson,x=value)) %>% arrange(-abs(cor))
